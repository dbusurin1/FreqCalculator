...
async function internalCallService(
	...
	// Allow unauthenticated users to make MCP calls
	// The backend will handle authorization based on the token (if present)
	// This enables public/demo access to MCP tools
